        ...
        <div className=' max-w-[100%] mx-auto'>
            <div className=' w-[90%] mx-auto'>
                <div className=' flex flex-col items-center justify-center py-20'>
                    <h1 className=' text-[#5147F5] font-[product] font-bold text-sm tracking-[.25em] uppercase py-2'>Find Courses</h1>
                    <h1 className=' md:text-[35px] text-2xl font-[product] font-bold'>Best Solutions For Life Coach Solutions</h1>
                </div>
