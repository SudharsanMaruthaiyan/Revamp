...
import { Blogtabcontent4Data } from "../../../API/Blogtabcontent4Data";
import { Blogtabcontent5Data } from "../../../API/Blogtabcontent5Data";

const Blogtabcontent5 = () => {
  return (
    <>
      <>
      <div className="max-w-[100%]">
        <div className="">
          ...
          <div className=" grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 my-10">
            {Blogtabcontent5Data.map((e, index) => {
              return (
                <>
                <Link to={"/blogdetails"}>
...
export default Blogtabcontent5
