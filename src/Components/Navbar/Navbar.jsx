  ...
  return (
    <>
      <div className=" max-w-[100%] mx-auto">
        <div className=" z-10 w-[80%] mx-auto lg:px-12 grid grid-cols-2 lg:grid-cols-2 py-4 lg:py-1 border items-center bg-white fixed px-4 md:right-10 md:left-10 right-4 left-4 top-5 rounded-md" id="nav-shadow">
          <div>
