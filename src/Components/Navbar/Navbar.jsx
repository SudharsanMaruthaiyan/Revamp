  ...
  return (
    <>
      <div className=" max-w-[100%] mx-auto">
        <div className=" z-10 w-[90%] mx-auto lg:px-12 grid grid-cols-2 lg:grid-cols-2 py-4 lg:py-1 shadow-2xl border items-center bg-white fixed px-4 md:right-10 md:left-10 right-4 left-4">
          <div>
          ...
          <div className=" py-5 hidden lg:flex lg:justify-end lg:bg-transparent bg-white">
            <ul className=" lg:static  hidden  flex-col lg:flex-row items-center  lg:flex gap-8 font-[Stylish] text-[20px] text-center">
              <li>
                <a href="" className=" font-[product] text-nowrap hover:text-[#FF9F00]">Home</a>
              </li>
              <li>
                <a href="#about" className=" font-[product] text-nowrap hover:text-[#FF9F00]">Hackathon</a>
              </li>
              <li>
                <Link to={"/course"}> <a className="font-[product] text-nowrap hover:text-[#FF9F00]">Course</a></Link>
              </li>
              <li>
                <a href="#schedule" className=" font-[product] text-nowrap hover:text-[#FF9F00]">About us</a>
              </li>
              <li>
                <a href="#venue" className=" font-[product] text-nowrap hover:text-[#FF9F00]">Contact</a>
              </li>
              <li className="">
